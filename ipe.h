...
Symbol *install(), *lookup(), *install_cadena();
...
extern  assign(), constpush(), dividir(), escribir(), eval(), funcion0(),
       ...
       distinto(), y_logico(), o_logico(), negacion(), leervariable(), concatenar(), leer_cadena(),
       eval_cadena(), escribir_cadena(), char_push(), forcode(), dowhilecode(), borrar_pantalla(), colocar_cursor();
